...
//  send_data[1] = 0b11011011;
//  send_data[3] = 0b10101010;
  /* USER CODE END 2 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, Diode_D2_Pin|Debug_Pin|LIDAR1_xShunt_out_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(LIDAR2_xShunt_out_GPIO_Port, LIDAR2_xShunt_out_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LIDAR2_xShunt_out_Pin */
  GPIO_InitStruct.Pin = LIDAR2_xShunt_out_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LIDAR2_xShunt_out_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LIDAR3_xShunt_out_Pin MAG_CS_GPIO_OUT_Pin */
  GPIO_InitStruct.Pin = LIDAR3_xShunt_out_Pin|MAG_CS_GPIO_OUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : LIDAR3_INT_EXTI1_Pin IMU_EXTI2_Pin MAG_DRDY_EXTI4_Pin */
  GPIO_InitStruct.Pin = LIDAR3_INT_EXTI1_Pin|IMU_EXTI2_Pin|MAG_DRDY_EXTI4_Pin;
  ...
  /*Configure GPIO pin : DUMMY_SD_GPIO_INPUT_Pin */
  GPIO_InitStruct.Pin = DUMMY_SD_GPIO_INPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DUMMY_SD_GPIO_INPUT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : MAG_INT_EXTI5_Pin */
  GPIO_InitStruct.Pin = MAG_INT_EXTI5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(MAG_INT_EXTI5_GPIO_Port, &GPIO_InitStruct);

  /*AnalogSwitch Config */
  HAL_SYSCFG_AnalogSwitchConfig(SYSCFG_SWITCH_PA1, SYSCFG_SWITCH_PA1_CLOSE);

  /* EXTI interrupt init*/
  HAL_NVIC_SetPriority(LIDAR3_INT_EXTI1_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(LIDAR3_INT_EXTI1_EXTI_IRQn);

  HAL_NVIC_SetPriority(IMU_EXTI2_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(IMU_EXTI2_EXTI_IRQn);

  HAL_NVIC_SetPriority(MAG_DRDY_EXTI4_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(MAG_DRDY_EXTI4_EXTI_IRQn);

  HAL_NVIC_SetPriority(MAG_INT_EXTI5_EXTI_IRQn, 0, 0);
  HAL_NVIC_EnableIRQ(MAG_INT_EXTI5_EXTI_IRQn);
